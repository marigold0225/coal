...
namespace Coal {
    ...
    public:
        ...
        RefMatrix(const ArgsType &args, const rowIndexType &row,
                      const colIndexType &col)
    ...
    void conditionSelect(
            const Eigen::MatrixBase<Derived> &tempMatrixs, const typename Derived::Scalar &prob_cut,
    ...
    void appendMatrixToBottom(const Eigen::MatrixBase<MatrixTypeA>& src,
                              Eigen::MatrixBase<MatrixTypeB>& dest,
                              long& numRowsInDest) {
